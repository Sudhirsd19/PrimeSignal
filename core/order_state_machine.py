...
class PositionContext:
    _LEGAL_TRANSITIONS = {
        ...
        OrderState.PARTIALLY_FILLED: {OrderState.PARTIALLY_FILLED, OrderState.FILLED, OrderState.SL_PLACEMENT_PENDING, OrderState.PROTECTED, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.EXECUTION_UNKNOWN, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        OrderState.FILLED: {OrderState.SL_PLACEMENT_PENDING, OrderState.PROTECTED, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.CLOSED, OrderState.EXECUTION_UNKNOWN, OrderState.EMERGENCY_FLATTENED},
        OrderState.SL_PLACEMENT_PENDING: {OrderState.PROTECTED, OrderState.EXECUTION_UNKNOWN, OrderState.EXIT_UNKNOWN, OrderState.CLOSING, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        OrderState.PROTECTED: {OrderState.TP1_LOCKED, OrderState.TP2_LOCKED, OrderState.RUNNER_ACTIVE, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.EXECUTION_UNKNOWN, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        OrderState.TP1_LOCKED: {OrderState.TP2_LOCKED, OrderState.RUNNER_ACTIVE, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.EXECUTION_UNKNOWN, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        OrderState.TP2_LOCKED: {OrderState.RUNNER_ACTIVE, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.EXECUTION_UNKNOWN, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        OrderState.RUNNER_ACTIVE: {OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.EXECUTION_UNKNOWN, OrderState.CLOSED, OrderState.EMERGENCY_FLATTENED},
        ...
        OrderState.EXECUTION_UNKNOWN: {OrderState.ORDER_ACK, OrderState.PARTIALLY_FILLED, OrderState.FILLED, OrderState.SL_PLACEMENT_PENDING, OrderState.PROTECTED, OrderState.CLOSING, OrderState.EXIT_UNKNOWN, OrderState.CLOSED, OrderState.REJECTED, OrderState.EMERGENCY_FLATTENED},
